...
```{r, echo = FALSE, results = 'asis'}
# ¿Realizó algún curso de formación específica para la actuación en el área de alcohol, tabaco y otras sustancias?
training_table <- cbind(prop.table(sort(table(students$professionals.training_questions.t_training_boolean), decreasing = TRUE)))*100
training_table <- cbind(sort(table(students$professionals.training_questions.t_training_boolean), decreasing = TRUE), training_table)
training_table <- data.frame(training_table)
training_table <- rownames_to_column(training_table, "options")

kable(training_table, 
      caption = "Frequência de profissionais que receberam intervenções breves", 
      digits = 1, align = c("l","c","c"),
      col.names = c("", "N", "%"))
```
...
students$professionals.training_questions.training_skip.training_assessment <- Recode(students$professionals.training_questions.training_skip.training_assessment,
                                                                       "'yes' = 'Sí'; 'no' = 'No'")
training_table <- cbind(prop.table(sort(table(students$professionals.training_questions.training_skip.training_assessment), decreasing = TRUE)))*100
training_table <- cbind(sort(table(students$professionals.training_questions.training_skip.training_assessment), decreasing = TRUE), training_table)
training_table <- data.frame(training_table)
training_table <- rownames_to_column(training_table, "options")

kable(training_table, 
      caption = "Frequência de profissionais que foram avaliados no curso", 
      digits = 1, align = c("l","c","c"),
      col.names = c("", "N", "%"))
```
...
students$professionals.training_questions.training_skip.training_certification <- Recode(students$professionals.training_questions.training_skip.training_certification,
                                                                       "'yes' = 'Sí'; 'no' = 'No'")
training_table <- cbind(prop.table(sort(table(students$professionals.training_questions.training_skip.training_certification), decreasing = TRUE)))*100
training_table <- cbind(sort(table(students$professionals.training_questions.training_skip.training_certification), decreasing = TRUE), training_table)
training_table <- data.frame(training_table)
training_table <- rownames_to_column(training_table, "options")

kable(training_table, 
      caption = "Frequência de profissionais que receberam certificação", 
      digits = 1, align = c("l","c","c"),
      col.names = c("", "N", "%"))
```
...
students$professionals.training_questions.training_skip.training_bi_useful <- Recode(students$professionals.training_questions.training_skip.training_bi_useful,
                                                                       "'yes' = 'Sí'; 'no' = 'No'")
training_table <- cbind(prop.table(sort(table(students$professionals.training_questions.training_skip.training_bi_useful), decreasing = TRUE)))*100
training_table <- cbind(sort(table(students$professionals.training_questions.training_skip.training_bi_useful), decreasing = TRUE), training_table)
training_table <- data.frame(training_table)
training_table <- rownames_to_column(training_table, "options")

kable(training_table, 
      caption = "¿Siente que la capacitación le ayudó en su trabajo para hacer detección temprana e intervención breve?", 
      digits = 1, align = c("l","c","c"),
      col.names = c("", "N", "%"))
```
...
students$professionals.training_questions.t_work_bi_screening <- Recode(students$professionals.training_questions.t_work_bi_screening,
                                                                       "'yes' = 'Sí'; 'no' = 'No'")
training_table <- cbind(prop.table(sort(table(students$professionals.training_questions.t_work_bi_screening), decreasing = TRUE)))*100
training_table <- cbind(sort(table(students$professionals.training_questions.t_work_bi_screening), decreasing = TRUE), training_table)
training_table <- data.frame(training_table)
training_table <- rownames_to_column(training_table, "options")

kable(training_table, 
      caption = "¿Realiza usted detección temprana e intervención breve en su día a día en el trabajo? ", 
      digits = 1, align = c("l","c","c"),
      col.names = c("", "N", "%"))
```
